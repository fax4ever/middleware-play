...
public class FineGrainedAtomicMapTest {
    ...
    public void test() throws Exception {
        Cache<String, Map<String, String>> cache = new DefaultCacheManager(INFINISPAN_DIST_XML).getCache("DEFAULT");
        ...
        List<Map.Entry<String, Map<String, String>>> collect = cache.entrySet().stream().collect(Collectors.toList());
